...
public class Game {
    ...
    public static void checkLetter(String input, char[] hiddenWord, char[] openWord) {
        // Checks a letter in the hidden word

        char lowerLetter = input.toLowerCase().charAt(0);
        char upperLetter = input.toUpperCase().charAt(0);
        for (int index = 0; index < hiddenWord.length; index++) {
            if (hiddenWord[index] == lowerLetter || hiddenWord[index] == upperLetter) {
